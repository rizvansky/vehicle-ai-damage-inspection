...
def task_wrapper(task_func: Callable) -> Callable:
    ...
    def wrap(cfg: DictConfig) -> tuple[dict[str, Any], dict[str, Any]]:
        ...
        Raises:
            ex: When something goes wrong during function execution.

        Returns:
            tuple[dict[str, Any], dict[str, Any]]: metric and object dictionaries returned by
                the input function.
        """
...
def get_metric_value(metric_dict: dict[str, Any], metric_name: str | None) -> float | None:
    ...
    Args:
        ...
        metric_name (str | None): If provided, the name of the metric to retrieve.

    Returns:
        float | None: If a metric name was provided, the value of the metric.
    """
